...
| 4 | TTL 30 j pour tous les certificats finaux | Périmètre réduit au seul rôle `infra` : le TLS sur les démons Bareos est abandonné, le renouvellement étant automatique la durée n'a plus d'enjeu | `-3-PKI.md` |
