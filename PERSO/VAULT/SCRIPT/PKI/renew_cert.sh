...
services=(proxmox pihole upsnap infra bareos-dir bareos-fd bareos-sd bareos postgresql cockpit)
domain=".sednal.lan"
base="/etc/Vault/PKI"
...
# === DEPLOIEMENT PROXMOX (192.168.0.252) ===
cible="sednal@192.168.0.252"
