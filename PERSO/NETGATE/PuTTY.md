# 📝 Utilisation de PuTTY pour réinitialiser le boîtier Netgate 1100.
...
### 2️⃣ Gestionnaire de périphériques

### 2.1) Dans Ports (COM et LPT) Choisir `Prolific PL2303GL USB Serial COM Port` ici COM3
### 2.2) Dans les Propriétés de `Prolific PL2303GL USB Serial COM Port` => Port Settings => Changer les Bits per second : 115200 puis OK
...
### 3.2) Appuyer sur `Enter` et le menu du Netgate 1100 est maintenant accessible :
