...
`[NOTE]` `A:/save` couvre également `A:/save/VPS_Mail/`, où le VPS dépose chaque
dimanche à 11h05 ses sauvegardes du serveur mail (archive de `~/DMS` et dump
PostgreSQL de SoGo). Le VPS n'est donc pas déclaré comme client Bareos.
