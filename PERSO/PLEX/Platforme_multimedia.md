# Installation de la solution Plex

---

### Ce tuto détaillera l'installation de la solution plex. Afin de créer une plateforme multimedia, utilisation du partage `NFS` pour lecture des fichier par Plex et partage `SMB` pour transfert fichier depuis la machine Admin (PC) => Plex (Debian).
...
### 1.1) Installation protocole NFS:
      sudo apt update
...
### Utilisation du partage /home/sednal (créer durant la partition du disque pour bareos)
...
### 2.1) Créer le Dossier d'installation
       mkdir Plex
       cd Plex
...
## ⚠️ Partage NFS Bibliothèque PLEX sur WEBUI et SMB doivent être le même dossier!
